...
public:
    ...
    void Init();
    void FillPedestalHistos(SRSFECPedestalDecoder* pedestalDecoder,
    ...
    Bool_t IsPedestalComputed() {
        return fIsPedestalComputed;
    }
    Bool_t IsMaskedChannelComputed() {
        return fIsMaskedChComputed;
    }
    
    void SetRunName(TString runname) {
        fRunName = runname;
    }
